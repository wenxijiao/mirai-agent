...
import lancedb
from yumi.core.features.config import load_model_config, save_model_config
from yumi.core.features.memory.backend import LanceDBBackend
from yumi.core.features.memory.embedding_state import is_degenerate_vector as _is_degenerate_vector
...
class EmbeddingProcessor:
    ...
    def _check_availability(self) -> bool:
        ...
        if config.embedding_provider == "ollama":
            from yumi.core.assets_check import assets_check
