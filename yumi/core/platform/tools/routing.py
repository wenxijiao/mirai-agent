...
def load_model_config():
    from yumi.core.features.config import load_model_config as _impl

    return _impl()


def get_embed_provider():
    from yumi.core.features.memory.embedding_state import get_embed_provider as _impl

    return _impl()


def is_degenerate_vector(vec) -> bool:
    from yumi.core.features.memory.embedding_state import is_degenerate_vector as _impl
