...
What moved
----------
* LanceDB connection, time/SQL helpers → :class:`~mirai.core.memories.backend.LanceDBBackend`
* Embedding state, dim migration, re-embed → :class:`~mirai.core.memories.embedding_runner.EmbeddingProcessor`
* Per-table CRUD → repositories under :mod:`mirai.core.memories.repos`
"""
